...
public class Server implements ITCPConnectionListener {
    ...
    @Override
    public synchronized void onConnectionReady(CommunicationBridge tcpConnection) {
        connections.add(tcpConnection);
        out.println("Client connected: " + tcpConnection);
    }

    @Override
    public synchronized void onReceiveString(CommunicationBridge tcpConnection, String value) {
        if (value == null){
            return;
        }
        out.println(value);
    ...
    @Override
    public synchronized void onException(CommunicationBridge tcpConnection, Exception e) {
        out.println("TCPConnection exception: " + e);
    }
}