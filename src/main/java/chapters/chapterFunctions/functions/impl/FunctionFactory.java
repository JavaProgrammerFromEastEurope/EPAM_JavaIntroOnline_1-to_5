...
public class FunctionFactory {
    ...
    private final Map<Integer, IFunction> sortFunctions   = new HashMap<>();
    private final Map<Integer, IFunction> decFunctions    = new HashMap<>();
    private final Map<Integer, IFunction> stringFunctions = new HashMap<>();
    private final Map<Integer, IFunction> buildFunctions  = new HashMap<>();
    private final Map<Integer, IFunction> regExpFunctions = new HashMap<>();
    ...
    public Map<Integer, IFunction> getBranchFunctions() {
        return branchFunctions;
    }

    public Map<Integer, IFunction> getCycleFunctions() {
        return cycleFunctions;
    }

    public Map<Integer, IFunction> getLineFunctions() {
        return lineFunctions;
    }

    public Map<Integer, IFunction> getArraysFunctions() {
        return arraysFunctions;
    }

    public Map<Integer, IFunction> getMatrixFunctions() {
        return matrixFunctions;
    }

    public Map<Integer, IFunction> getSortFunctions() {
        return sortFunctions;
    }

    public Map<Integer, IFunction> getDecFunctions() {
        return decFunctions;
    }

    public Map<Integer, IFunction> getStringFunctions() {
        return stringFunctions;
    }

    public Map<Integer, IFunction> getBuildFunctions() {
        return buildFunctions;
    }

    public Map<Integer, IFunction> getRegExpFunctions() {
